...
export default function TracerStudiesPage() {
  return (
    <Phase9ResourcePage
      ...
      columns={[{ key: "alumni.name", label: "Alumni" }, { key: "year", label: "Tahun" }, { key: "status", label: "Status" }, { key: "companyName", label: "Perusahaan" }, { key: "university", label: "Kampus" }, { key: "businessName", label: "Usaha" }]}
      ...
      eyebrow="Phase 9 BKK"
      fields={[
        { name: "alumniId", label: "ID Alumni", required: true },
