...
export class TracerStudiesService {
  ...
  async create(input: unknown, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "tracer-study.create", entity: "tracer_study", entityId: item.id, metadata: { alumniId: item.alumniId, year: item.year } });
    return item;
  }
  ...
  async update(id: string, input: unknown, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "tracer-study.update", entity: "tracer_study", entityId: id, metadata: data });
    return item;
  }
  ...
  async delete(id: string, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "tracer-study.delete", entity: "tracer_study", entityId: id, metadata: {} });
