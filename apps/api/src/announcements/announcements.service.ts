...
export class AnnouncementsService {
  ...
  async delete(id: string, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "announcement.delete", entity: "announcement", entityId: id, metadata: {} });
  ...
  async archive(id: string, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "announcement.archive", entity: "announcement", entityId: id, metadata: {} });
    return item;
  }
