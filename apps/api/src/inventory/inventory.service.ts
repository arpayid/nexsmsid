...
export class InventoryService {
  ...
  async createCategory(dto: CreateInventoryCategoryDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.category.create", entity: "InventoryCategory", entityId: category.id, metadata: { code: category.code } as any });
    return category;
  }
  ...
  async updateCategory(id: string, dto: UpdateInventoryCategoryDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.category.update", entity: "InventoryCategory", entityId: updated.id, metadata: { code: updated.code } as any });
    return updated;
  }
  ...
  async deleteCategory(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.category.delete", entity: "InventoryCategory", entityId: id, metadata: {} as any });
    return { success: true };
  }
  ...
  async createLocation(dto: CreateInventoryLocationDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.location.create", entity: "InventoryLocation", entityId: location.id, metadata: { code: location.code } as any });
    return location;
  }
  ...
  async updateLocation(id: string, dto: UpdateInventoryLocationDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.location.update", entity: "InventoryLocation", entityId: updated.id, metadata: { code: updated.code } as any });
    return updated;
  }
  ...
  async deleteLocation(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.location.delete", entity: "InventoryLocation", entityId: id, metadata: {} as any });
    return { success: true };
  }
  ...
  async createItem(dto: CreateInventoryItemDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.item.create", entity: "InventoryItem", entityId: item.id, metadata: { code: item.code, categoryId: item.categoryId } as any });
  ...
  async updateItem(id: string, dto: UpdateInventoryItemDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.item.update", entity: "InventoryItem", entityId: updated.id, metadata: { code: updated.code } as any });
    return updated;
  }
  ...
  async deleteItem(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.item.delete", entity: "InventoryItem", entityId: id, metadata: {} as any });
    return { success: true };
  }
  ...
  async createMovement(dto: CreateInventoryMovementDto, actorId: string) {
    ...
    return await this.prisma.$transaction(async (tx: any) => {
      ...
      await this.audit.record({ actorId, action: dto.type === "TRANSFER" ? "inventory.transfer" : "inventory.movement.create", entity: "InventoryItem", entityId: item.id, metadata: { movementType: dto.type, quantity: dto.quantity } as any });
  ...
  async createMaintenance(dto: CreateInventoryMaintenanceDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.maintenance.create", entity: "InventoryMaintenance", entityId: maintenance.id, metadata: { itemId: maintenance.itemId } as any });
    return maintenance;
  }
  ...
  async updateMaintenance(id: string, dto: UpdateInventoryMaintenanceDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.maintenance.update", entity: "InventoryMaintenance", entityId: maintenance.id, metadata: {} as any });
    return maintenance;
  }
  ...
  async startMaintenance(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.maintenance.start", entity: "InventoryMaintenance", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async completeMaintenance(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.maintenance.complete", entity: "InventoryMaintenance", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async cancelMaintenance(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.maintenance.cancel", entity: "InventoryMaintenance", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async createLoan(dto: CreateInventoryLoanDto, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.loan.create", entity: "InventoryLoan", entityId: loan.id, metadata: { itemId: loan.itemId } as any });
    return loan;
  }
  ...
  async approveLoan(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.loan.approve", entity: "InventoryLoan", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async rejectLoan(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.loan.reject", entity: "InventoryLoan", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async markLoanBorrowed(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.loan.borrowed", entity: "InventoryLoan", entityId: id, metadata: {} as any });
    return updated;
  }

  async returnLoan(id: string, actorId: string) {
    const loan = await this.getLoan(id);
    if (loan.status !== "BORROWED" && loan.status !== "OVERDUE") throw new BadRequestException("Loan must be BORROWED or OVERDUE to return");
    ...
    await this.audit.record({ actorId, action: "inventory.loan.return", entity: "InventoryLoan", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async cancelLoan(id: string, actorId: string) {
    ...
    await this.audit.record({ actorId, action: "inventory.loan.cancel", entity: "InventoryLoan", entityId: id, metadata: {} as any });
    return updated;
  }
  ...
  async getSummary() {
    const [totalItems, activeAssets, damagedAssets, inMaintenance, borrowedLoans, lowStockItems] = await Promise.all([
      ...
      this.prisma.inventoryItem.findMany({ where: { deletedAt: null } }).then((items: any[]) => items.filter((i: any) => i.minStock && i.quantity <= i.minStock).length)
    ]);
  ...
  async getLowStockItems() {
    ...
    return items.filter((i: any) => i.minStock !== null && i.quantity <= i.minStock);
  }
