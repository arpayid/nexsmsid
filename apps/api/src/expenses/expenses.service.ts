...
export class ExpensesService {
  ...
  async create(input: unknown, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "expense.create", entity: "expense", entityId: expense.id, metadata: { expenseNumber, amount: data.amount } });
    return expense;
  }
  ...
  async update(id: string, input: unknown, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "expense.update", entity: "expense", entityId: id, metadata: data });
    return expense;
  }
  ...
  async approve(id: string, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "expense.approve", entity: "expense", entityId: id, metadata: {} });
    return expense;
  }
