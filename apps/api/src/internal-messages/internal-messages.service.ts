...
export class InternalMessagesService {
  ...
  async send(input: unknown, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "message.send", entity: "internal_message", entityId: item.id, metadata: { recipientId: data.recipientId } });
    return item;
  }
  ...
  async markRead(id: string, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "message.read", entity: "internal_message", entityId: id, metadata: {} });
    return item;
  }
  ...
  async delete(id: string, actor: AuthenticatedUser, meta: RequestMeta) {
    ...
    await this.auditService.record({ ...meta, actorId: actor.id, action: "message.delete", entity: "internal_message", entityId: id, metadata: {} });
