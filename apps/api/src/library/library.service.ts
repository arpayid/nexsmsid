...
export class LibraryService {
  ...
  async createCategory(dto: CreateLibraryCategoryDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.category.create", entity: "Created library category", metadata: {
  ...
  async updateCategory(id: string, dto: UpdateLibraryCategoryDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.category.update", entity: "Updated library category", metadata: {
      categoryId: id,
    } });
  ...
  async deleteCategory(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.category.delete", entity: "Deleted library category", metadata: {
      categoryId: id,
    } });
  ...
  async createShelf(dto: CreateLibraryShelfDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.shelf.create", entity: "Created library shelf", metadata: {
      shelfId: shelf.id,
    } });
  ...
  async updateShelf(id: string, dto: UpdateLibraryShelfDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.shelf.update", entity: "Updated library shelf", metadata: {
      shelfId: id,
    } });
  ...
  async deleteShelf(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.shelf.delete", entity: "Deleted library shelf", metadata: {
      shelfId: id,
    } });
  ...
  async createBook(dto: CreateLibraryBookDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.book.create", entity: "Created library book", metadata: {
      bookId: book.id,
    } });
  ...
  async updateBook(id: string, dto: UpdateLibraryBookDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.book.update", entity: "Updated library book", metadata: {
      bookId: id,
    } });
  ...
  async getCopies(bookId: string, params: {
    page?: number;
    limit?: number;
    ...
    const where: any = { bookId, deletedAt: null };
    if (status) where.status = status;
  ...
  async createCopy(bookId: string, dto: CreateLibraryBookCopyDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.copy.create", entity: "Created library book copy", metadata: {
      copyId: copy.id,
    } });
  ...
  async updateCopy(id: string, dto: UpdateLibraryBookCopyDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.copy.update", entity: "Updated library book copy", metadata: {
      copyId: id,
    } });
  ...
  async deleteCopy(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.copy.delete", entity: "Deleted library book copy", metadata: {
      copyId: id,
    } });
  ...
  async createMember(dto: CreateLibraryMemberDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.member.create", entity: "Created library member", metadata: {
      memberId: member.id,
    } });
  ...
  async updateMember(id: string, dto: UpdateLibraryMemberDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.member.update", entity: "Updated library member", metadata: {
      memberId: id,
    } });
  ...
  async deleteMember(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.member.delete", entity: "Deleted library member", metadata: {
      memberId: id,
    } });
  ...
  async getLoans(params: {
    ...
    const [data, total] = await Promise.all([
      this.prisma.libraryLoan.findMany({
        ...
        take: limit,
        include: {
          member: { select: { memberCode: true, type: true, student: { select: { name: true } }, teacher: { select: { name: true } }, externalName: true } },
  ...
  async createLoan(dto: CreateLibraryLoanDto, userId: string) {
    ...
    if (copy.status !== 'AVAILABLE') throw new BadRequestException('Copy is not available');

    const activeLoansCount = await this.prisma.libraryLoan.count({
    ...
    if (member.userId) {
      ...
      }).catch((e: any) => this.logger.error('Failed to notify member', e));
    }
  ...
  async createReservation(dto: CreateLibraryReservationDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.reservation.create", entity: "Created reservation", metadata: {
  ...
  async markReservationReady(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.reservation.ready", entity: "Marked reservation ready", metadata: {
      reservationId: id,
    } });
  ...
  async cancelReservation(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.reservation.cancel", entity: "Cancelled reservation", metadata: {
      reservationId: id,
    } });
  ...
  async expireReservation(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.reservation.expire", entity: "Expired reservation", metadata: {
      reservationId: id,
    } });
  ...
  async getFines(params: {
    ...
    const [data, total] = await Promise.all([
      this.prisma.libraryFine.findMany({
        ...
        take: limit,
        include: {
          member: { select: { memberCode: true, student: { select: { name: true } }, teacher: { select: { name: true } }, externalName: true } },
  ...
  async payFine(id: string, dto: PayLibraryFineDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.fine.pay", entity: "Paid library fine", metadata: {
      fineId: id,
    } });
  ...
  async waiveFine(id: string, dto: WaiveLibraryFineDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.fine.waive", entity: "Waived library fine", metadata: {
      fineId: id,
    } });
  ...
  async cancelFine(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "library.fine.cancel", entity: "Cancelled library fine", metadata: {
      fineId: id,
    } });
