...
export class PayrollService {
  ...
  async createComponent(data: CreatePayrollComponentDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.component.create", entity: "Created payroll component", metadata: { componentId: created.id } });
    return created;
  }
  ...
  async updateComponent(id: string, data: UpdatePayrollComponentDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.component.update", entity: "Updated payroll component", metadata: { componentId: id } });
    return updated;
  }
  ...
  async deleteComponent(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.component.delete", entity: "Deleted payroll component", metadata: { componentId: id } });
    return { success: true };
  }
  ...
  async createEmployeeComponent(data: CreateEmployeeSalaryComponentDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.employee_component.create", entity: "Assigned component to employee", metadata: { escId: created.id } });
    return created;
  }
  ...
  async updateEmployeeComponent(id: string, data: UpdateEmployeeSalaryComponentDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.employee_component.update", entity: "Updated employee component", metadata: { escId: id } });
    return updated;
  }
  ...
  async deleteEmployeeComponent(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.employee_component.delete", entity: "Deleted employee component", metadata: { escId: id } });
    return { success: true };
  }
  ...
  async createPeriod(data: CreatePayrollPeriodDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.create", entity: "Created payroll period", metadata: { periodId: created.id } });
    return created;
  }
  ...
  async updatePeriod(id: string, data: UpdatePayrollPeriodDto, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.update", entity: "Updated payroll period", metadata: { periodId: id } });
    return updated;
  }
  ...
  async openPeriod(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.open", entity: "Opened payroll period", metadata: { periodId: id } });
    return updated;
  }

  async calculatePeriod(id: string, userId: string) {
    await this.calcService.calculatePeriod(id, userId);
    await this.audit.record({ actorId: userId, action: "payroll.period.calculate", entity: "Calculated payroll period", metadata: { periodId: id } });
  ...
  async approvePeriod(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.approve", entity: "Approved payroll period", metadata: { periodId: id } });
    return updated;
  }
  ...
  async closePeriod(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.close", entity: "Closed payroll period", metadata: { periodId: id } });
    return updated;
  }
  ...
  async cancelPeriod(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.cancel", entity: "Cancelled payroll period", metadata: { periodId: id } });
    return updated;
  }
  ...
  async deletePeriod(id: string, userId: string) {
    ...
    await this.audit.record({ actorId: userId, action: "payroll.period.delete", entity: "Deleted payroll period", metadata: { periodId: id } });
    return { success: true };
  }
  ...
  async getSummary() {
    ...
    let totalGross = 0, totalDeductions = 0, totalNet = 0, runsCount = 0;
    if (currentPeriod) {
